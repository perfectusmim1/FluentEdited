...
ElementsTable.Dropdown = (function()
	...
	function Element:New(Idx, Config)
		...
		local DropdownHolderFrame = New("Frame", {
			...
			SearchBoxFrame, -- SearchBox en üstte
			DropdownScrollFrame,
			New("UICorner", {
				CornerRadius = UDim.new(0, 7),
			}),
		...
		function Dropdown:BuildDropdownList()
			local Values = FilteredValues[1] and FilteredValues or Dropdown.Values
			local Buttons = {}
...
ElementsTable.Colorpicker = (function()
	...
	function Element:New(Idx, Config)
		...
		local function CreateColorDialog()
			...
			--[[
			-- Buraya dikkat
			-- Dropdown açıldığında arama kutusunu sıfırla ve tüm değerleri göster
			-- ]]
			SearchBox.Input.Text = ""
			FilterDropdownValues("")
			Dropdown:BuildDropdownList()
